...
MveRenderer::MveRenderer(MveWindow& window, MveDevice& device)
...
void MveRenderer::recreateSwapChain() {
  ...
  if (lveSwapChain == nullptr) {
    lveSwapChain = std::make_unique<MveSwapChain>(lveDevice, extent);
  } else {
    std::shared_ptr<MveSwapChain> oldSwapChain = std::move(lveSwapChain);
    lveSwapChain = std::make_unique<MveSwapChain>(lveDevice, extent, oldSwapChain);
