...
FirstApp::FirstApp() {
  globalPool =
      MveDescriptorPool::Builder(lveDevice)
...
void FirstApp::run() {
  ...
  auto globalSetLayout =
      MveDescriptorSetLayout::Builder(lveDevice)
  ...
  viewerObject.transform.translation = {0.f, 0.5f, -4.f};
...
void FirstApp::loadGameObjects() {
  lveModel = MveModel::createModelFromFile(lveDevice, "models/plane.obj");
  ...
  for (int i = 0; i < lightColors.size(); i++) {
    auto pointLight = MveGameObject::makePointLight(3.f, 0.5f);
