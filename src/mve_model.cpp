...
namespace std {
template <>
struct hash<lve::MveModel::Vertex> {
  size_t operator()(lve::MveModel::Vertex const &vertex) const {
    size_t seed = 0;
...
MveModel::MveModel(MveDevice &device, const MveModel::Builder &builder) : lveDevice{device} {
...
std::unique_ptr<MveModel> MveModel::createModelFromFile(
    MveDevice &device, const std::string &filepath) {
  Builder builder{};
